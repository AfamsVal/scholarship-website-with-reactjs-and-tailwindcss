...
const Footer = () => {
  return (
    <footer className='relative bg-indigo-900 text-white px-4 py-10'>
      <div className='flex flex-col md:flex-row'>
        <div className='w-full lg:w-2/6 lg:mx-4 lg:pr-8'>
          <img src={logo} alt='' className='md:w-48 w-32 mt-5 md:mt-0' />
          <p className='text-gray-400'>
            AFR STUD is a great place to absorb knowledge from heavy hitters in your industry.
          </p>
          ...
          <form className='flex items-center mt-6'>
            <div className='w-full'>
              ...
              <div className='relative'>
                ...
                <button
                  type='submit'
                  className='bg-indigo-900 hover:bg-black text-white px-4 py-2 text-sm font-bold rounded absolute top-0 right-0 my-2 mr-2'
                >
                  Subscribe
                </button>
              </div>
        ...
        <div className='w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4'>
          <h5 className='uppercase tracking-wider font-semibold text-white'>Quick Link</h5>
          <ul className='mt-4'>
            <li className='mt-2'>
        ...
        <div className='w-full lg:w-2/6 mt-8 lg:mt-0 lg:mx-4 lg:pr-8'>
          <h5 className='uppercase tracking-wider font-semibold text-white'>Contact Details</h5>
          <ul className='mt-4'>
            <li>
              <Link to='#' title='' className='block items-center opacity-75 hover:opacity-100'>
                <svg
                ...
                <span className='ml-3'>
                  Plot 93, Oyo street, off Moshood Abiola Way, area 2, section 1, Garki-Abuja
                </span>
              </Link>
            </li>
            <li className='mt-4'>
              <Link to='#' title='' className='flex items-center opacity-75 hover:opacity-100'>
                <span>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    width='24'
            ...
            <li className='mt-4'>
              <Link to='#' title='' className='flex items-center opacity-75 hover:opacity-100'>
                ...
                <span className='ml-3'>+37069221174 | +2348082369281</span>
              </Link>
            </li>
            <li className='mt-4'>
              <Link to='#' title='' className=' flex items-center opacity-75 hover:opacity-100'>
                ...
                <span className='ml-3'>contact@afrstud.com</span>
              </Link>
            </li>
          </ul>
        </div>
        ...
        <div className='w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4'>
          <h5 className='uppercase tracking-wider font-semibold text-white'>We're Social</h5>
          ...
          <p className='text-sm text-gray-100 mt-12'>
            © 2020 AFR STUD. <br className='hidden lg:block' />
            All Rights Reserved.
          </p>
        </div>
      </div>
